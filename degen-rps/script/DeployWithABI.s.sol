...
contract DeployWithABIScript is Script {
    function run() public {
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY");
        if (deployerPrivateKey == 0) {
            // Use default anvil account if no private key set
        ...
        console.log("\n=== Copy this to frontend/deployments.json ===");
        console.log("{");
        ...
        console.log('  }');
        console.log("}");
        console.log("\nNote: ABIs will need to be added manually or extracted from out/ directory");
    }
}
